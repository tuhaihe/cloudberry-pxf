...
public class HdfsWritableTextTest extends BaseWritableFeature {
    ...
    public void textFormatInsertNoProfile() throws Exception {
        ...
        writableExTable.setFragmenter("org.apache.cloudberry.pxf.plugins.hdfs.HdfsDataFragmenter");
        writableExTable.setAccessor("org.apache.cloudberry.pxf.plugins.hdfs.LineBreakAccessor");
        writableExTable.setResolver("org.apache.cloudberry.pxf.plugins.hdfs.StringPassResolver");
