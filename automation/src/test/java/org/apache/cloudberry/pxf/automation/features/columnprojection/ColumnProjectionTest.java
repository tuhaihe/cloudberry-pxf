package org.apache.cloudberry.pxf.automation.features.columnprojection;
    ...
    public void checkColumnProjection() throws Exception {
        ...
        if (gpdb.getVersion() >= 7) {
             ...
             * The Call stack is different in case of external-table and FDW.
             ...
             FDW options: (format 'text', delimiter ',', "null" E'\\N', escape E'\\', format_type 't', location_uris 'pxf://dummy_path?PROFILE=test:text&FRAGMENTER=org.apache.cloudberry.pxf.automation.testplugin.ColumnProjectionVerifyFragmenter&ACCESSOR=org.apache.cloudberry.pxf.automation.testplugin.ColumnProjectionVerifyAccessor&RESOLVER=org.apache.cloudberry.pxf.plugins.hdfs.StringPassResolver', execute_on 'ALL_SEGMENTS', log_errors 'f', encoding '6', is_writable 'false')
             ...
             colprojvalue | text    |           |          |         |             | extended |              |
             Server: default_test
             FDW options: (resource 'dummy_path', format 'text', fragmenter 'org.apache.cloudberry.pxf.automation.testplugin.ColumnProjectionVerifyFragmenter', accessor 'org.apache.cloudberry.pxf.automation.testplugin.ColumnProjectionVerifyAccessor', resolver 'org.apache.cloudberry.pxf.plugins.hdfs.StringPassResolver', delimiter ',')
