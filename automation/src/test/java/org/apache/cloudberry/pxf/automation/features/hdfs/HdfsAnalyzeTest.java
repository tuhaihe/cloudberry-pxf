...
public class HdfsAnalyzeTest extends BaseFeature {
    ...
    public void analyzeOnSequenceSmall() throws Exception {
        ...
        exTable.setAccessor("org.apache.cloudberry.pxf.plugins.hdfs.SequenceFileAccessor");
        exTable.setResolver("org.apache.cloudberry.pxf.plugins.hdfs.WritableResolver");
