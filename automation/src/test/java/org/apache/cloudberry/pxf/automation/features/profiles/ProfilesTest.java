package org.apache.cloudberry.pxf.automation.features.profiles;
...
import org.apache.cloudberry.pxf.automation.structures.profiles.Profile;
...
public class ProfilesTest extends BaseFeature {
    ...
    public void customProfile() throws Exception {
        ...
        hdfsTextSimpleProfile.setAccessor("org.apache.cloudberry.pxf.plugins.hdfs.LineBreakAccessor");
        hdfsTextSimpleProfile.setResolver("org.apache.cloudberry.pxf.plugins.hdfs.StringPassResolver");
        hdfsTextSimpleProfile.setFragmenter("org.apache.cloudberry.pxf.plugins.hdfs.HdfsDataFragmenter");
        // clean profiles list
