...
import org.apache.cloudberry.pxf.automation.datapreparer.CustomTextPreparer;
import org.apache.cloudberry.pxf.automation.datapreparer.QuotedLineTextPreparer;
...
import org.apache.cloudberry.pxf.automation.structures.tables.pxf.ErrorTable;
import org.apache.cloudberry.pxf.automation.structures.tables.utils.TableFactory;
import org.apache.cloudberry.pxf.automation.utils.csv.CsvUtils;
...
public class HdfsReadableTextTest extends BaseFeature {
    ...
    private void runMultiBlockedMultiLinedCsvTest(String locationPath, String hdfsPath, boolean useProfile) throws Exception {
        ...
        if (useProfile) {
            ...
            exTable.setProfile("test:csv"); // set dynamic test: profile that will be ignored
            exTable.setFragmenter("org.apache.cloudberry.pxf.plugins.hdfs.HdfsDataFragmenter");
            exTable.setAccessor("org.apache.cloudberry.pxf.plugins.hdfs.QuotedLineBreakAccessor");
            exTable.setResolver("org.apache.cloudberry.pxf.plugins.hdfs.StringPassResolver");
        }
        gpdb.createTableAndVerify(exTable);
        // Verify results
