...
description: Reading and writing SequenceFile data in object stores via PXF.
sidebar_position: 8
---
...
Refer to [Example: Writing Binary Data to HDFS](../access-hadoop/hdfs_seqfile.md#example-writing-binary-data-to-hdfs) in the PXF HDFS SequenceFile documentation for a write/read example. Modifications that you must make to run the example with an object store include:
